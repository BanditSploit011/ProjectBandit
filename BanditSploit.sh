clear
	...
	echo
	echo $blue"          ======================+++++++++++==================="
	echo $red"            nginstall dulu ya coeg... By Bandit.IDiots"   
	sleep 1
	echo '''\a
	\033[34;1m                              _
	\033[32;1m                             / |
	...
	echo
	echo $blue"         ======================+++++++++++==================="
	echo $red"            Jika Anda Gans Maka Proses Installasi akan cepat By Bandit.IDiots"
	sleep 1
	echo '''\a
	\033[32;1m                             ____
	\033[34;1m                            |___ \
	...
	echo
	echo $blue"         ======================+++++++++++==================="
	echo $red"            Semakin Gans Semakin Cepat Masuk ke Menu By Bandit.IDiots"
	sleep 1
	echo '''\a
	\033[35;1m                            _____
	\033[36;1m                           |___ /
	...
	echo
	echo $pur"==================="$cy" ============================="
	echo $i"##"$me"  AUTHOR  :  Bandit.IDiots  "$i"               ##"
	echo $i"##"$pu"  WhatsApp:  089523269343 "$i"                    ##" 
	echo $pur"==================="$cy" ============================="
	echo $i"[" $me" TOOLS CREATED BANDIT.IDIOTS", $bi"DIBUAT PADA TANGGAL 21 SEPTEMBER 2019" $i"]"
	echo $i"[" $me" TOOLS FREE USE, NO NEED TO PAYS" $pu"!!!" $i"]"
	echo "~~~~~~~~~~~~~~~~~~~~~"$me"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	echo
	echo $cy"PROJECT BANDITᵏ Menu:"
	echo
	echo $me"[==============="$pu"===============]"
	...
	echo
	echo $pur"Project Bandit["$pur"Tentukan pilihan kamu Sekarang"$pur"]"
	read -p"Project Bandit " pil
...
if [ $pil = 74 ]
	...
	if [ $pil = 83 ]
	then
	toilet -f big -F gay "Project Bandit.IDiots"
	clear
	...
	sleep 2
	echo $pur"Bila Ada Kesalahan Anda Bisa Nanya Melalui Via Whatsapp 08923269343"
	sleep 2
	...
	sleep 2
	echo $pur"Tools Dibuat Oleh Bandit.IDiots"
	exit
	fi
